    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleHasRights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleHasRights_Rights_RightId",
                        column: x => x.RightId,
                        principalTable: "Rights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleHasRights_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleHasRights_RightId",
                table: "RoleHasRights",
                column: "RightId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleHasRights_RoleId_RightId",
                table: "RoleHasRights",
                columns: new[] { "RoleId", "RightId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserHasRoles_UserId_RoleId",
                table: "UserHasRoles",
